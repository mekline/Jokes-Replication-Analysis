...
MyOutputFolder = [MyOutputPath 'ToMfROIS_resp_Cloudy_20180312']; %Change to match this analysis!!
...
crit_cons = {{'ment','pain','phys','reln'}}; %Effect of interest contrasts: cons of the crit. experiment do we want to measure there? It could be the same as the loc! In that case SPM will make ur data independent for you :)
...
loc_sessions = {{'168_KAN_evDB_20141020b_PL2017',...
"288_FED_20160411a_3T1_PL2017",...
...
crit_sessions = {{"168_FED_20160204a_3T2_PL2017",...
