...
MyOutputFolder = [MyOutputPath 'ToMfROIS_resp_Cloudy_20180226']; %Change to match this analysis!!
...
crit_cons = {{'ment','pain','ment-pain'}}; %Effect of interest contrasts: cons of the crit. experiment do we want to measure there? It could be the same as the loc! In that case SPM will make ur data independent for you :)
