...
MyOutputFolder = [MyOutputPath 'LangfROIs_resp_Lang_20170703']; %Change to match this analysis!!



firstlevel_loc = 'firstlevel_langlocSN'; % path to the first-level analysis directory for the lang localizer or whatever
firstlevel_crit = 'firstlevel_langlocSN'; %path to 1st-level analysis directory for the critical task


loc_cons = {{'S-N'}}; %Which contrast used to localize issROIs?
crit_cons = {{'S','N','S-N'}}; %Effect of interest contrasts: cons of the crit. experiment do we want to measure there? It could be the same as the loc! In that case SPM will make ur data independent for you :)
